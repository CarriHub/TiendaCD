 ...
 * @author Carri
 */
@WebServlet(name = "EditarPedido", urlPatterns = {"/admin/EditarPedido"})
public class EditarPedido extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(idPedidoStr != null){
            Pedido pedido = control.getPedido(Integer.parseInt(idPedidoStr));
            pedido.setEstado(EstadoPedido.valueOf(request.getParameter("estado")));
            control.editarPedido(pedido);
        }
        
        request.setAttribute("pedidos", control.getPedidos());
