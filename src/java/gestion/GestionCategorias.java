...
public class GestionCategorias extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //Eliminar categoria
        String categoriaEliminar = request.getParameter("idEliminar");
        if(categoriaEliminar != null){
            int idEliminar = Integer.parseInt(categoriaEliminar);
            control.eliminarCategoria(idEliminar);
        }
        
        //Categoria nueva
        String nombreCat = request.getParameter("nombreCat");
        if (nombreCat != null && !nombreCat.isBlank()) {
            Part parte = request.getPart("imagenCat");
            ...
            Categoria categoriaNueva = new Categoria(nombreCat, nombreFichero);
            control.crearCategoria(categoriaNueva);
        }
